...
public class ConnectionPool {
	...
	private ConnectionPool() {
		...
		try {
			this.poolSize = Integer.parseInt(dbResourceManager.getValue(DBParameter.DB_POOL_SISE));	
			initPoolData();
	...
	public void initPoolData() {
		...
		try {
			...
			logger.log(Level.ERROR, "Wrong db properties.", e);
			throw new DaoRuntimeException("Wrong db properties.", e);
			
		} catch (ClassNotFoundException e) {
			logger.log(Level.ERROR, "Can't find database driver class.", e);
			throw new DaoRuntimeException("Can't find database driver class", e);
